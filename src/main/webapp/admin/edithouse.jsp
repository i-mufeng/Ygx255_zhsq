		...
		<div class="maincontent">
			<div class="maincontentinner">
				<div class="widget" style="width: 90%; margin: 0 auto;">
					<h4 class="widgettitle">编辑房产</h4>
					<div class="widgetcontent nopadding">
						<form class="stdform stdform2" method="post" action="house/updateHouse.action" name="myform" method="post">
							...
							<p class="stdformbutton" align="center">
								<input type="hidden" name="houseid" id="houseid" value="${house.houseid}" /><input type="hidden" name="status"
									...
									value="${house.addtime}" /><input type="hidden" name="usersid" id="usersid" value="${house.usersid}" />
