	...
	<div class="mainwrapper">
		<div class="maincontent">
			<div class="maincontentinner">
				<h4 class="widgettitle">物业收费查询</h4>
				...
				<div class="dataTables_info" id="dyntable_info" style="text-align: right;">
					<form action="money/queryMoneyByCond.action" name="myform" method="post">
						查询条件: <select name="cond" style="width: 100px">
							<option value="mno">按收费单号查询</option>
							<option value="usersid">按业主用户查询</option>
							<option value="houseid">按房产查询</option>
							<option value="programsid">按收费项目查询</option>
							<option value="money">按收费金额查询</option>
