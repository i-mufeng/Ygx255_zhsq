	...
	<div class="mainwrapper">
		<div class="maincontent">
			<div class="maincontentinner">
				<h4 class="widgettitle">报损报修查询</h4>
				...
				<div class="dataTables_info" id="dyntable_info" style="text-align: right;">
					<form action="broken/queryBrokenByCond.action" name="myform" method="post">
						查询条件: <select name="cond" style="width: 100px">
							<option value="bno">按报损单号查询</option>
							<option value="usersid">按业主用户查询</option>
							<option value="reason">按报损原因查询</option>
							<option value="contents">按损失描述查询</option>
							<option value="addtime">按报损日期查询</option>
