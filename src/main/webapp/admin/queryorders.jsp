	...
	<div class="mainwrapper">
		<div class="maincontent">
			<div class="maincontentinner">
				<h4 class="widgettitle">服务预约查询</h4>
				...
				<div class="dataTables_info" id="dyntable_info" style="text-align: right;">
					<form action="orders/queryOrdersByCond.action" name="myform" method="post">
						查询条件: <select name="cond" style="width: 100px">
							<option value="ordercode">按预约单号查询</option>
							<option value="usersid">按业主用户查询</option>
							<option value="houseid">按房产查询</option>
							<option value="servsid">按服务查询</option>
							<option value="addtime">按下单日期查询</option>
							<option value="orderdate">按服务日期查询</option>
							<option value="sections">按时间段查询</option>
