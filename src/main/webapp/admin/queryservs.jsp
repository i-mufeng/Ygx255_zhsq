	...
	<div class="mainwrapper">
		<div class="maincontent">
			<div class="maincontentinner">
				<h4 class="widgettitle">物业服务查询</h4>
				...
				<div class="dataTables_info" id="dyntable_info" style="text-align: right;">
					<form action="servs/queryServsByCond.action" name="myform" method="post">
						查询条件: <select name="cond" style="width: 100px">
							<option value="servsname">按服务名称查询</option>
							<option value="money">按收费金额查询</option>
							<option value="hits">按点击数查询</option>
							<option value="sellnum">按预约次数查询</option>
