	...
	<div class="mainwrapper">
		<div class="maincontent">
			<div class="maincontentinner">
				<h4 class="widgettitle">网站栏目列表</h4>
				<table id="dyntable" class="table table-bordered responsive">
					...
					<c:forEach items="${bannerList}" var="banner">
						<tr style="text-align: center;">
							...
							<td style="text-align: center;">${banner.addtime}</td>
							<td style="text-align: center;">${banner.memo}</td>
							<td style="text-align: center;"><a href="banner/getBannerById.action?id=${banner.bannerid}">编辑</a>&nbsp;&nbsp;<a
