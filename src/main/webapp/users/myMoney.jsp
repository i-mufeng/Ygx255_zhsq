	...
	<div class="mainWrap clearfix">
		<div class="main_tit">
			<div class="main_titT main_titTa" style="width: 99%">
				<img src="themes/crm_blue1/img/bri_icon1.png"> <a href="index/index.action">首页</a>> 我的账单
			</div>
		</div>
			...
			<div class="main_conDiv" id="vsb_content_501">
				<div class="v_news_content">
					<table style="width: 99%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
						<tr>
							<td height="30" colspan="9" align="center" background="themes/crm_blue1/img/bg.png" class="white14B">我的账单</td>
						</tr>
						<tr>
							<td align="center" bgcolor="#FFFFFF">收费单号</td>
							<td align="center" bgcolor="#FFFFFF">业主用户</td>
							<td align="center" bgcolor="#FFFFFF">房产</td>
							<td align="center" bgcolor="#FFFFFF">收费项目</td>
							<td align="center" bgcolor="#FFFFFF">收费金额</td>
						...
						<c:forEach items="${moneyList}" var="money">
							<tr align="center" bgcolor="#FFFFFF">
								...
								<td style="text-align: center;"><c:if test="${money.status eq '待缴费'}">
										<a href="index/prePay.action?id=${money.moneyid}">缴费</a>
									</c:if></td>
							</tr>
						</c:forEach>
					</table>
