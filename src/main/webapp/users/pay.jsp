	...
	<div class="mainWrap clearfix">
		<div class="main_tit">
			<div class="main_titT main_titTa" style="width: 99%">
				<img src="themes/crm_blue1/img/bri_icon1.png"> <a href="index/index.action">首页</a>> 支付账单
			</div>
		</div>
									...
									<dl class="content">
										...
										<dd id="btn-dd">
											<span class="new-btn-login-sp">
												...
												type="hidden" name="id" id="ordersid" value="${money.moneyid}" /> <input type="hidden" name="basepath"
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "${money.mno}";
		document.getElementById("WIDtotal_amount").value = "${money.money}";
	}
	GetDateNow();
</script>