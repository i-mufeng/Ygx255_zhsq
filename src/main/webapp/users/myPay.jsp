	...
	<div class="mainWrap clearfix">
		<div class="main_tit">
			<div class="main_titT main_titTa" style="width: 99%">
				<img src="themes/crm_blue1/img/bri_icon1.png"> <a href="index/index.action">首页</a>> 我的缴费记录
			</div>
		</div>
			...
			<div class="main_conDiv" id="vsb_content_501">
				<div class="v_news_content">
					<table style="width: 99%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
						<tr>
							<td height="30" colspan="9" align="center" background="themes/crm_blue1/img/bg.png" class="white14B">我的缴费记录</td>
						</tr>
						<tr>
							<td align="center" bgcolor="#FFFFFF">业主用户</td>
							<td align="center" bgcolor="#FFFFFF">缴费单</td>
